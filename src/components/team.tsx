...
export function Team() {
  return (
    <section
      id="team"
      className="min-h-screen py-20  sm:w-full bg-black  bg-dot-white/[0.2] relative flex items-center justify-center"
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl font-bold text-white mb-4 brightness-100">
            Our Team
          </h2>
