...
export default function Prototyping() {
  return (
    <ServiceLayout
      ...
      intro="At ERAYA, prototyping is an essential part of our innovation process. We transform concepts and CAD designs into functional, tangible models that help clients evaluate form, fit, function, and performance."
