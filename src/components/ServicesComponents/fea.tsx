...
const FEA = () => {
  ...
  const quote =
    "Engineering confidence begins with analysis — ERAYA delivers precision through simulation before fabrication.";
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden text-white bg-black py-6 px-6 mt-0">
      ...
      <div className="relative z-10 max-w-[90rem] w-full mx-auto bg-[url('/assets/FEA-bg.png')] bg-cover bg-center bg-no-repeat backdrop-blur-xl border border-white/10 pt-6 pb-12 px-6 rounded-3xl shadow-2xl space-y-8 mb-20">
        ...
        <div className="relative z-10">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            At <span className="font-bold text-white">ERAYA</span>, our Finite
            Element Analysis (FEA) Division ensures your designs meet strength,
            safety, and performance standards. We use simulation-based
            engineering to validate concepts, predict real-world behavior, and
            reduce costly physical prototyping across multiple industries.
          </motion.div>
          ...
          >
            <Section
              title={
                <>
                  <span className="text-orange-300">🔍</span> Structural &
                  Thermal Analysis
                </>
              }
              data={[
            ...
            <Section
              title={
                <>
                  <span className="text-blue-300">🔬</span> Material &
          ...
          >
            ...
            {["/assets/FEA-1.png", "/assets/FEA-2.png"].map((src, i) => (
              <div
                key={i}
          ...
          <div
            ...
            data-aos="fade-up"
          >
            {["/assets/FEA-3.png", "/assets/FEA-8.png"].map((src, i) => (
              <div
                key={i}
                className="w-full md:w-1/4 transition-transform duration-300 hover:scale-105 cursor-pointer"
                onClick={() => setSelectedImage(src)}
