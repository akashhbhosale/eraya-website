...
export default function TalentServices() {
  return (
    <ServiceLayout
      ...
      intro="At ERAYA, our Talent Services division specializes in deploying skilled engineering professionals across CAD, CAM, FEA, testing and structural domains. Whether augmenting your inhouse team or leading independent projects, our vetted engineers bring speed, accuracy and innovation to your workflows."
      ...
      whyChooseUs={[
        "Access to prevetted engineering professionals",
